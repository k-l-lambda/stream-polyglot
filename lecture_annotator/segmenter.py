...
Uses an OpenAI-compatible model (default: gpt-x.x) to segment the full
...
DEFAULT_BASE_URL = os.environ.get("LLM_BASE_URL", "https://api.ppinfra.com/v3/openai")
DEFAULT_SEGMENT_MODEL = "pa/gpt-5.4"
